...
.controller("recordsInPatientController", function($scope, utils, $location){
	...
	.fromFnPromise(function(){
		return utils.serverRequest('/consultancy/patient-admission/view-received-patients?resourceId='+$scope.currentWard, 'GET');
	})
